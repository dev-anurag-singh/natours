...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2YW51cmFna3IiLCJhIjoiY2tuNDN5ZDNuMW5tcjJubnp6dWN2M2FycSJ9.grXVlynzcdGExXSJfbEuGA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/devanuragkr/ckn483izy1gi517mr4sw7lp25',
    scrollZoom: false
  });
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(oldPassword, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var stripe = Stripe('pk_test_51IdU85SEYYt4RG19lakhz0Emajfnz2hhbmm55sMhc7wbxI9Ns4td0ar3EUT4I49pzIyDHfql8D5McN1aoySBCk6S00m08I4XAS');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/check-out-window/".concat(tourId));
...
// DOM
var mapLocations = document.getElementById('map');
...
if (mapLocations) {
  var locations = JSON.parse(mapLocations.dataset.locations);
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUser.updatePassword)(oldPassword, password, passwordConfirm);
  });
}
